...
// Carte de partage « prête à poster » (thème Noir, taille fixe). La capture (web + natif)
// la rasterise en PNG. Fond opaque pour un rendu propre une fois exporté.
  ...
  ({ bet, username }, ref) => {
    ...
    return (
      <View ref={ref} collapsable={false} style={{ width: 340, backgroundColor: '#0A0A0B', padding: 22 }}>
        ...
        {/* Titre résultat */}
        <Text className="mt-5 font-display text-[24px] text-white">
          {TITLE[bet.status] ?? TITLE.pending}
        </Text>
